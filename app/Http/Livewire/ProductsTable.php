...
class ProductsTable extends Component
{
    ...
    public function addToCart($product_id){
        ...
        Cart::add(['id' => $product[0]->id, 'name'=> $product[0]->slug, 'qty'=> $this->quantity[$product_id], 'price'=> $product[0]->priceShop, 'weight'=> '0', 'options'=> ['slug' => $product[0]->categoryName, 'brand' => $product[0]->brand, 'avatar' => $product[0]->avatar, 'taste' => $product[0]->tasteBond->taste]]);
