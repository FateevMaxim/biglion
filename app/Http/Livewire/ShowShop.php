...
class ShowShop extends Component
{
    ...
    public function addToCart($slug){
        ...
        Cart::add(['id' => $product[0]->id, 'name'=> $product[0]->slug, 'qty'=> '1', 'price'=> $product[0]->priceShop, 'weight'=> '0', 'options'=> ['slug' => $product[0]->categoryName, 'avatar' => $product[0]->avatar, 'taste' => $product[0]->tasteBond->taste]]);
