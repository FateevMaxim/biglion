...
/*----------------------------------------*/
	function makeTimer($endDate, $this, $format) {
		...
		var yearsLeft = yearsLeft < 10 ? "0" + yearsLeft : yearsLeft,
			...
			yearsText = yearsLeft > 1 ? 'лет' : 'дет',
			monthsText = monthsLeft > 1 ? 'месяцев' : 'месяц',
			weeksText = weeksLeft > 1 ? 'недель' : 'недели',
			daysText = daysLeft > 1 ? 'дней' : 'дня',
			hourText = hrsLeft > 1 ? 'часов' : 'час',
			minsText = minsLeft > 1 ? 'мин.' : 'мин.',
			secText = secsLeft > 1 ? 'сек.' : 'сек.';
